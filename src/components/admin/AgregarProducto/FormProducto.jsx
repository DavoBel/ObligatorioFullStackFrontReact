...
import { agregarProducto } from '../../../features/ProductosSlice'
import { useNavigate } from 'react-router';
import { joiResolver } from '@hookform/resolvers/joi';
import { productoSchema } from '../../../validators/productos.validators';
...
const FormProducto = () => {
    ...
    const onSubmit = data => {
        ...
        api.post(`/productos/`, formData).then(r=>{
            agregarProducto(r.data);
            navigate(`/productos`);
        }).catch(e=>console.log(e));
    };

    useEffect(()=>{
        api.get(`/categorias?page=1&limit=0`).then(r=>{
    ...
    const cargarImagenPrevia = e =>{
        ...
        setVistaPrevia(foto ? URL.createObjectURL(foto) : null);
    }
